...
4. `pythonscripting pip` allowes you check, install or remove external python modules.<br/>Check [pip usage](#using-pip-to-install-external-modules) for details
