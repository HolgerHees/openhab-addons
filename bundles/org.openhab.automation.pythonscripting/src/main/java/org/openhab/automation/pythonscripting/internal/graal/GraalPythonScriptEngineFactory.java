...
public final class GraalPythonScriptEngineFactory implements ScriptEngineFactory {
    ...
    private static final Engine polyglotEngine = createDefaultEngine();
    private static final Language language = polyglotEngine.getLanguages().get(LANGUAGE_ID);

    private static final String ENGINE_NAME = "Graal.py";
    private static final String NAME = "python";

    private static final String[] EXTENSIONS = { "py", "pyc" };
    ...
    GraalPythonScriptEngineFactory(Engine engine) {
